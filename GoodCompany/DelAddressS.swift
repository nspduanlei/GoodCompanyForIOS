...
struct DelAddressS: DelAddressP {
    
    private let urlPath = Constants.TEST_BASE_URL + "address/del"

    
    func delAddress(addressId: Int, completionHandler: DefaultCompletionHandler) -> Request {
